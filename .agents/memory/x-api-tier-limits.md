...
- CAN: post standalone tweets (incl. long >280 chars), upload media via v1.1 `uploadMedia` and attach, read user timelines (`userByUsername` + `userTimeline` with public_metrics works), plain retweets of any account (`v2.retweet` confirmed working July 2026).
